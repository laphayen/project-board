...
import com.laphayen.projectboard.dto.response.ArticleWithCommentsResponse;
import com.laphayen.projectboard.service.ArticleService;
import com.laphayen.projectboard.service.PaginationService;
...
public class ArticleController {
    ...
    public String searchArticleHashtage(
            @RequestParam(required = false) String searchValue,
            @PageableDefault(size = 10, sort = "createdAt", direction = Sort.Direction.DESC) Pageable pageable,
            ModelMap map
    ) {
    ...
    public String postNewArticle(ArticleRequest articleRequest) {
        ...
        articleService.saveArticle(articleRequest.toDto(UserAccountDto.of(
                "laphayen1", "qwer1234", "laphayen1@mail.com", "laphayen1", "memo"
        )));
    ...
    public String updateArticle(@PathVariable Long articleId, ArticleRequest articleRequest) {
        ...
        articleService.updateArticle(articleId, articleRequest.toDto(UserAccountDto.of(
                "laphayen1", "qwer12341", "laphayen1@mail.com", "laphayen1", "memo"
        )));
